...
CRITICAL — TOTAL POTENTIAL SAVINGS: Calculate total_potential_savings in results_summary as the sum of patient_responsibility values from flagged lines only, excluding any oop_proximity or oop_max_violation flags. Do not include OOP flag amounts in the total. Format as "up to $X,XXX.XX". If no non-OOP flags exist, use "$0.00".`;
